...
#ifndef DUEROS_DCS_APP_MEDIAPLAYER_MP3STREAMPLAYER_H_
#define DUEROS_DCS_APP_MEDIAPLAYER_MP3STREAMPLAYER_H_
...
public:
    Mp3StreamPlayer(const std::string &audio_dev);
...
private:
    Mp3StreamPlayer(const Mp3StreamPlayer&);

    Mp3StreamPlayer &operator=(const Mp3StreamPlayer&);
...
#endif  // DUEROS_DCS_APP_MEDIAPLAYER_MP3STREAMPLAYER_H_
